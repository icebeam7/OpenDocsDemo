...
namespace OpenDocsDemo.Controllers
{
    ...
    {
        string pptxMIMEType = "application/vnd.openxmlformats-officedocument.presentationml.presentation.main";
        ...
        public IActionResult CreatePresentation()
        {
            ...
            {
                var presentationDoc = PresentationDocument.Create(stream, PresentationDocumentType.Presentation, true);
                ...
                return File(stream.ToArray(), pptxMIMEType, "PowerPoint Presentation Basic Example.pptx");
            }
        }
